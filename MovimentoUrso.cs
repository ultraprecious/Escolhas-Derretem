...
public class MovimentoUrso : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (!podeMoverCenario || estaNaAgua)
        {
            ...
            if (estaNaAgua) rb.linearVelocity = new Vector2(0, rb.linearVelocity.y);
    ...
    public void SetPodeMoverCenario(bool podeMover)
    {
        ...
        else
        {
            ...
            if (estaNaAgua)
            {
                ...
                rb.linearVelocity = new Vector2(rb.linearVelocity.x, 0); // Zera velocidade vertical para pulo limpo
    ...
    public void TeleportarUrsoParaBanquisa(BanquisaController banquisaAlvo)
    {
        ...
        rb.linearVelocity = Vector2.zero; // Zera a velocidade para evitar movimentos indesejados
