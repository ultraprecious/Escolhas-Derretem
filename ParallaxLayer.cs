...
{
    [Header("Configuração da Esteira")]
    ...
    // NOVO: Variável para controlar se a camada deve se mover
    ...
    void Update()
    {
        // Se não puder mover, simplesmente sai do Update
        if (!podeMover) return;
    ...
    // NOVO: Método público para controlar o movimento da camada
