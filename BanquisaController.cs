...
{
    [Header("Configura��es da Banquisa")]
    [Tooltip("Dura��o do processo de derretimento (opacidade de 1 para 0).")]
    [SerializeField] public float meltDuration = 1.0f; // MUDADO: de private para PUBLIC
    [Tooltip("Dura��o do processo de restaura��o (opacidade de 0 para 1).")]
    ...
    private IEnumerator FadeSprite(float targetAlpha, float duration, bool isMelting)
    {
        ...
        if (isMelting && banquisaCollider != null)
        {
            ...
            Debug.Log($"Banquisa '{gameObject.name}' colisor desativado ap�s derretimento visual.");
        }
    }
